                                ...
                                <div class="table-responsive">
                                    <table class="table table-nowrap mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">Hồ sơ làm việc :</th>
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cv{{ $user->id }}">Xem</button>

                                                    <div class="modal fade" id="cv{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    @if (substr($user->cv, -3) == 'pdf')
                                                                        <embed src="{{ asset($user->cv) }}" width="766px" height="600px" />
                                                                    @else
                                                                        Chưa có hồ sơ làm việc
                                                                    @endif
                                                                </div>
