...
@section('title') Cập nhật lương @endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật lương</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('salaries.index') }}" title="Quản lý lương" data-toggle="tooltip" data-placement="top">Quản lý lương</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="repeater custom-validation" method="POST" action="{{ route('salaries.update', $data_edit->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @include('salary._form', ['routeUpdate' => 1])
                        </form>
